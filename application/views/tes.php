                                        ...
                                        <ul>
                                            ...
                                            <li class="flyout-right"> <a href="#">Authentication</a>
                                                <ul>
                                                    ...
                                                    <li><a href="login_one.html" target="_blank">Login with bg image</a>
                                                    </li>
...
<!-- <div class="modal fade" id="viewdatapermintaansaldo" tabindex="-1" role="dialog"
    aria-labelledby="viewdatapermintaansaldo" aria-hidden="true">
                ...
                <div class="modal-body">
                    <div class="w-100">
                        <span class="badge bg-warning d-block w-100 text-dark text-center"
                            style="font-size: 14px;"><strong>Proses</strong></span>
                    </div>
                    <br>
                    <div class="card-body">
                        <table class="table">
...
<!-- <div class="col-xl-9 box-col-7 proorders-xl-2">
            <div class="card">
                <div class="card-header pb-0">
                    <div class="header-top">
                        <h4>Total Saldo Petty Cash Saat Ini</h4><span> (Juni 2025)</span>
                    </div>
                </div>
                <div class="card-body pt-0 summary-card">
                    <span class="f-w-700 f-14 d-block mb-3"></span>
                    <div class="row">
                        <div class="col-xl-4">
                            <div class="card">
                                <div class="card-header pb-0 border-t-danger">
                                    <h4>JAKARTA</h4>
                                    <p class="mt-1 f-m-light">JKT</p>
                                </div>
                                <div class="card-body">
                                    <ul>
                                        <li>
                                            <h3>Rp.
                                                <?= number_format($saldo_jakarta->saldo_pettycash ?? 0, 0, ',', '.') ?>
                                            </h3>
                                            <div><span>(30 Hari)</span></div>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-4">
                            <div class="card">
                                <div class="card-header pb-0 border-t-info">
                                    <h4>BALIKPAPAN</h4>
                                    <p class="mt-1 f-m-light">BPP</p>
                                </div>
                                <div class="card-body">
                                    <ul>
                                        <li>
                                            <h3>Rp.
                                                <?= number_format($saldo_balikpapan->saldo_pettycash ?? 0, 0, ',', '.') ?>
                                            </h3>
                                            <div><span>(30 Hari)</span></div>
                                        </li>
                                    </ul>
                        ...
                        <div class="col-xl-4">
                            <div class="card">
                                <div class="card-header pb-0 border-t-warning">
                                    <h4>KARIMUN</h4>
                                    <p class="mt-1 f-m-light">TBK</p>
                                </div>
                                <div class="card-body">
                                    <ul>
                                        <li>
                                            <h3>Rp.
                                                <?= number_format($saldo_karimun->saldo_pettycash ?? 0, 0, ',', '.') ?>
                                            </h3>
                                            <div><span>(30 Hari)</span></div>
                                        </li>
                                    </ul>
                    ...
                    <div class="row">
                        <div class="col-xl-3">
                            <div class="card">
                                <div class="card-header pb-0 border-t-primary">
                                    <h4>GALANG</h4>
                                    <p class="mt-1 f-m-light">LAY-UP</p>
                                </div>
                                <div class="card-body">
                                    <ul>
                                        <li>
                                            <h3>Rp.
                                                <?= number_format($saldo_galang->saldo_pettycash ?? 0, 0, ',', '.') ?>
                                            </h3>
                                            <div><span>(30 Hari)</span></div>
                                        </li>
                                    </ul>
                        ...
                        <div class="col-xl-3">
                            <div class="card">
                                <div class="card-header pb-0 border-t-secondary">
                                    <h4>SEKUPANG</h4>
                                    <p class="mt-1 f-m-light">BBM PILOT BOAT</p>
                                </div>
                                <div class="card-body">
                                    <ul>
                                        <li>
                                            <h3>Rp.
                                                <?= number_format($saldo_sekupang_bbm->saldo_pettycash ?? 0, 0, ',', '.') ?>
                                            </h3>
                                            <div><span>(30 Hari)</span></div>
                                        </li>
                                    </ul>
                        ...
                        <div class="col-xl-3">
                            <div class="card">
                                <div class="card-header pb-0 border-t-success">
                                    <h4>SEKUPANG</h4>
                                    <p class="mt-1 f-m-light">SERVICE BOAT</p>
                                </div>
                                <div class="card-body">
                                    <ul>
                                        <li>
                                            <h3>Rp.
                                                <?= number_format($saldo_sekupang_sb->saldo_pettycash ?? 0, 0, ',', '.') ?>
                                            </h3>
                                            <div><span>(30 Hari)</span></div>
                                        </li>
                                    </ul>
                        ...
                        <div class="col-xl-3">
                            <div class="card">
                                <div class="card-header pb-0 border-t-danger">
                                    <h4>SEKUPANG</h4>
                                    <p class="mt-1 f-m-light">ATK/RTK</p>
                                </div>
                                <div class="card-body">
                                    <ul>
                                        <li>
                                            <h3>Rp.
                                                <?= number_format($saldo_sekupang_rtk->saldo_pettycash ?? 0, 0, ',', '.') ?>
                                            </h3>
                                            <div><span>(30 Hari)</span></div>
                                        </li>
                                    </ul>

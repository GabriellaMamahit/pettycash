    ...
    <div class="page-title">
        <div class="row">
            <div class="col-xl-4 col-sm-7 box-col-3">
                <h3>Laporan Petty Cash Sekupang - ATK/RTK</h3>
            </div>
...
<div class="container-fluid default-dashboard2">
    <div class="row">
        <div class="col-xl-8 col-md-12 box-col-6">
            <div class="card">
                <div class="card-header pb-0">
                    <h4 class="text-center">Bukti Pengeluaran Kas Kecil Sekupang - ATK/RTK</h4>
                </div>
        ...
        <div class="col-xl-4 col-md-12">
            <div class="card">
                <div class="card-header pb-0">
                    <h4 class="text-center">Debet & Kredit ATK/RTK</h4>
                </div>
                <div class="card-body chart-block">
            ...
            <div class="card">
                <div class="card-header card-no-border">
                    <div class="header-top">
                        <h4>Daftar Bukti Pengeluaran Kas Kecil Sekupang - ATK/RTK</h4>
                ...
                <div class="card-body pt-0">
                    ...
                    <div class="table-responsive">
                        <table class="last-orders-table table" id="last-orders">
                            ...
                            <tbody>
                                <?php $no = 1;
                                foreach ($rowlapbpkkcabpa_atkrtk as $data) { ?>
                                <tr>

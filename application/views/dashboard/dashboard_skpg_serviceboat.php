    ...
    <div class="page-title">
        <div class="row">
            <div class="col-xl-3 col-sm-7 box-col-3">
                <h3>Kantor Pemandan Sekupang (Service Boat) </h3>
            </div>
            ...
            <div class="col-xl-3 col-sm-5 box-col-4">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Sekupang (Service Boat)</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card social-profile">
                <div class="card-body">
                    <?php foreach ($data_saldoservicesekupang as $saldo): ?>
                    <div class="row mt-3 ">
                        <div class="col-sm-9">
                            <div class="d-flex">
                                ...
                                <div class="social-img-wrap">
                                    <div class="social-img"><img
                                            src="<?= base_url() ?>assets/images/flags/money-in-hand-danger.png"
                                            alt="profile">
                                    </div>
                                    <div class="edit-icon">
                                        <svg>
                                ...
                                <div class="flex-grow align-self-center ms-2 ">
                                    <h1 class="mt-0 user-name">Akun Service Boat Sekupang</h1>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="progress-showcase row mt-3">
                        <div class="col">
                            <div class="progress progress-border-primary">
                                <?php
                                    $debet = $saldo['saldodebetservicesekupang'];   // Pemasukan
                                    $kredit = $saldo['saldokreditservicesekupang']; // Pengeluaran
                        ...
                        <ul class="social-follow"
                            ...
                            <li style="flex: 1;">
                                <h5 class="mb-0" style="margin-bottom: 2px; font-size: clamp(11px, 2vw, 18px);">
                                    Rp. <?= number_format($saldo['saldodebetservicesekupang'], 0, ',', '.') ?>
                                </h5>
                            ...
                            <li
                                ...
                                <h5 class="mb-0" style="margin-bottom: 2px; font-size: clamp(11px, 2vw, 18px);">
                                    Rp. <?= number_format($saldo['saldokreditservicesekupang'], 0, ',', '.') ?>
                                </h5>
                            ...
                            <li style="flex: 1;">
                                <h5 class="mb-0" style="margin-bottom: 2px; font-size: clamp(11px, 2vw, 18px);">
                                    Rp. <?= number_format($saldo['saldoservicesekupang'], 0, ',', '.') ?>
                                </h5>
                    ...
                    <!-- <div class="social-details">
                        ...
                        <ul class="social-follow">
                            <li>
                                <h5 class="mb-0">Rp.
                                    <?= number_format($saldo['saldodebetservicesekupang'], 0, ',', '.') ?></h5>
                                <span class="f-light">Budget Saldo</span>
                            </li>
                            <li>
                                <h5 class="mb-0">Rp.
                                    <?= number_format($saldo['saldokreditservicesekupang'], 0, ',', '.') ?></h5>
                                <span class="f-light">Pengeluaran (Kredit)</span>
                            </li>
                            <li>
                                <h5 class="mb-0">Rp. <?= number_format($saldo['saldoservicesekupang'], 0, ',', '.') ?>
                                </h5><span class="f-light">Sisa Saldo Petty Cash</span>
                            </li>
                        </ul>
                    </div> -->
                    <?php endforeach; ?>
                    <button class="btn btn-pill btn-primary btn-air-primary mt-3 btn-exp" type="button"
                        ...
                        <?= ($saldo['saldoservicesekupang'] <= 15000) ? 'disabled' : '' ?>>Tambah Pengeluaran</button>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-header card-no-border">
                    <div class="header-top">
                        <h4>Data Transaksi Service Boat Pemanduan Sekupang</h4>
                        <?php
                        $hasRembesOpenDone = false;

                        // 1. Hitung total data dengan status_cab = In progress (untuk JKT)
                        $total_inprogress = $this->db->where('jenis_saldo', 'PA_SB')
                        ...
                        $total_inprogress_done = $this->db->where('jenis_saldo', 'PA_SB')
                            ->where('status_cab', 'In progress')
                            ->where('rembesment', 'Open')
                ...
                <div class="card-body pt-0">
                    ...
                    <div class="table-responsive mb-4">
                        <table class="last-orders-table table" id="last-orders">
                            ...
                            <tbody>
                                <?php $no = 1;
                                foreach ($rowtransaksiserviceboatsekupang as $data) { ?>
                    ...
                    <form class="row g-3 needs-validation"
                        ...
                        <div class="card-wrapper">
                                ...
                                <div class="mb-3">
                                    <div class="input-group">
                                        <input class="form-control" type="text" id="no-bpkk-display" name="no_bpkk"
                                            value="<?= $no_bpkkservicesekupang; ?>" placeholder="BPKK-SBU/0000/MM/YYYY"
                                            readonly>
                            ...
                            <div class="row mb-3">
                                ...
                                <?php
                                $saldo = 0;
                                $saldo = $this->db->get_where('tb_saldo', ['jenis_saldo' => 'PA_SB'])->row()->saldo_pettycash ?? 0;
                                ?>
                                <div class="col-md-6">
                                    ...
                                    <input type="hidden" id="address_cab" name="address_cab" value="PA_SB">

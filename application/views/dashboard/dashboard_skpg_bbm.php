    ...
    <div class="page-title">
        <div class="row">
            <div class="col-xl-3 col-sm-7 box-col-3">
                <h3>Kantor Pemanduan Sekupang (BBM)</h3>
            </div>
            ...
            <div class="col-xl-3 col-sm-5 box-col-4">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Sekupang (BBM Boat)</li>
                </ol>
            </div>
        </div>
    </div>
                ...
                <div class="card-body">
                            ...
                            <div class="d-flex">
                                ...
                                <div class="social-img-wrap">
                                    <div class="social-img"><img
                                            src="<?= base_url() ?>assets/images/flags/money-in-hand-secondary.png"
                                            alt="profile">
                                    </div>
                                    <div class="edit-icon">
                                        <svg>
                                ...
                                <div class="flex-grow align-self-center ms-2 ">
                                    <h1 class="mt-0 user-name">Akun BBM Boat Sekupang</h1>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="social-details">
                        ...
                        <ul class="social-follow">
                            <li>
                                <h5 class="mb-0">Rp. <?= number_format($saldo['saldodebetbbmsekupang'], 0, ',', '.') ?>
                                </h5>
                                <span class="f-light">Budget Saldo</span>
                            </li>
                            <li>
                                <h5 class="mb-0">Rp. <?= number_format($saldo['saldokreditbbmsekupang'], 0, ',', '.') ?>
                                </h5>
                                <span class="f-light">Pengeluaran (Kredit)</span>
                            </li>
                            <li>
                                <h5 class="mb-0">Rp. <?= number_format($saldo['saldobbmsekupang'], 0, ',', '.') ?></h5>
                ...
                <div class="card-body pt-0">
                    ...
                    <div class="table-responsive mb-4">
                        <table class="last-orders-table table" id="last-orders">
                            ...
                            <tbody>
                                <?php $no = 1;
                                foreach ($rowtransaksibbmsekupang as $data) { ?>
                    ...
                    <form class="row g-3 needs-validation"
                        ...
                        <div class="card-wrapper">
                                ...
                                <div class="mb-3">
                                    <div class="input-group">
                                        <input class="form-control" type="text" id="no-bpkk-display" name="no_bpkk"
                                            value="<?= $no_bpkkbbmsekupang; ?>" placeholder="BPKK-SBU/0000/MM/YYYY"
                                            readonly>
                            ...
                            <div class="row mb-3">
                                ...
                                <?php
                                $saldo = 0;
                                $saldo = $this->db->get_where('tb_saldo', ['jenis_saldo' => 'PA_BBM'])->row()->saldo_pettycash ?? 0;
                                ?>
                                <div class="col-md-6">
                                    ...
                                    <input type="hidden" id="address_cab" name="address_cab" value="PA_BBM">

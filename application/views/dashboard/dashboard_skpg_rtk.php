    ...
    <div class="page-title">
        <div class="row">
            <div class="col-xl-3 col-sm-7 box-col-3">
                <h3>Kantor Pemanduan Sekupang (ATK/RTK)</h3>
            </div>
            ...
            <div class="col-xl-3 col-sm-5 box-col-4">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Sekupang (RTK)</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card social-profile">
                <div class="card-body">
                    <?php foreach ($data_saldortksekupang as $saldo): ?>
                    <div class="row mt-3 ">
                        <div class="col-sm-9">
                            <div class="d-flex">
                                ...
                                <div class="social-img-wrap">
                                    <div class="social-img"><img
                                            src="<?= base_url() ?>assets/images/flags/money-in-hand-grey.png"
                                            alt="profile">
                                    </div>
                                    <div class="edit-icon">
                                        <svg>
                                ...
                                <div class="flex-grow align-self-center ms-2 ">
                                    <h1 class="mt-0 user-name">Akun ATK/RTK Sekupang</h1>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="progress-showcase row mt-3">
                        <div class="col">
                            <div class="progress progress-border-primary">
                                <?php
                                    $debet = $saldo['saldodebetrtksekupang'];   // Pemasukan
                                    $kredit = $saldo['saldokreditrtksekupang']; // Pengeluaran
                        ...
                        <ul class="social-follow"
                            ...
                            <li style="flex: 1;">
                                <h5 class="mb-0" style="margin-bottom: 2px; font-size: clamp(11px, 2vw, 18px);">
                                    Rp. <?= number_format($saldo['saldodebetrtksekupang'], 0, ',', '.') ?>
                                </h5>
                            ...
                            <li
                                ...
                                <h5 class="mb-0" style="margin-bottom: 2px; font-size: clamp(11px, 2vw, 18px);">
                                    Rp. <?= number_format($saldo['saldokreditrtksekupang'], 0, ',', '.') ?>
                                </h5>
                            ...
                            <li style="flex: 1;">
                                <h5 class="mb-0" style="margin-bottom: 2px; font-size: clamp(11px, 2vw, 18px);">
                                    Rp. <?= number_format($saldo['saldortksekupang'], 0, ',', '.') ?>
                                </h5>
                    ...
                    <!-- <div class="social-details">
                        ...
                        <ul class="social-follow">
                            <li>
                                <h5 class="mb-0">Rp. <?= number_format($saldo['saldodebetrtksekupang'], 0, ',', '.') ?>
                                </h5>
                                <span class="f-light">Budget Saldo</span>
                            </li>
                            <li>
                                <h5 class="mb-0">Rp. <?= number_format($saldo['saldokreditrtksekupang'], 0, ',', '.') ?>
                                </h5>
                                <span class="f-light">Pengeluaran (Kredit)</span>
                            </li>
                            <li>
                                <h5 class="mb-0">Rp. <?= number_format($saldo['saldortksekupang'], 0, ',', '.') ?></h5>
                    ...
                    <button class="btn btn-pill btn-primary btn-air-primary mt-3 btn-exp" type="button"
                        ...
                        <?= ($saldo['saldortksekupang'] <= 15000) ? 'disabled' : '' ?>>Tambah Pengeluaran</button>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-header card-no-border">
                    <div class="header-top">
                        <h4>Data Transaksi ATK/RTK Pemanduan Sekupang</h4>
                        <?php
                        $hasRembesOpenDone = false;

                        // 1. Hitung total data dengan status_cab = In progress (untuk JKT)
                        $total_inprogress = $this->db->where('jenis_saldo', 'PA_RTK')
                        ...
                        $total_inprogress_done = $this->db->where('jenis_saldo', 'PA_RTK')
                            ->where('status_cab', 'In progress')
                            ->where('rembesment', 'Open')
                ...
                <div class="card-body pt-0">
                    ...
                    <div class="table-responsive mb-4">
                        <table class="last-orders-table table" id="last-orders">
                            ...
                            <tbody>
                                <?php $no = 1;
                                foreach ($rowtransaksirtksekupang as $data) { ?>
                    ...
                    <form class="row g-3 needs-validation"
                        ...
                        <div class="card-wrapper">
                                ...
                                <div class="mb-3">
                                    <div class="input-group">
                                        <input class="form-control" type="text" id="no-bpkk-display" name="no_bpkk"
                                            value="<?= $no_bpkkrtksekupang; ?>" placeholder="BPKK-SBU/0000/MM/YYYY"
                                            readonly>
                            ...
                            <div class="row mb-3">
                                ...
                                <?php
                                $saldo = 0;
                                $saldo = $this->db->get_where('tb_saldo', ['jenis_saldo' => 'PA_RTK'])->row()->saldo_pettycash ?? 0;
                                ?>
                                <div class="col-md-6">
                                    ...
                                    <input type="hidden" id="address_cab" name="address_cab" value="PA_RTK">

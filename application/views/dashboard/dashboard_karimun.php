        ...
        <div class="row">
            ...
            <div class="col-xl-3 col-sm-5 box-col-4">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Karimun</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card social-profile">
                <div class="card-body">
                    <?php foreach ($data_saldokarimun as $saldo): ?>
                    <div class="row mt-3 ">
                        <div class="col-sm-9">
                            <div class="d-flex">
                                ...
                                <div class="social-img-wrap">
                                    <div class="social-img"><img
                                            src="<?= base_url() ?>assets/images/flags/money-in-hand-success.png"
                                            alt="profile">
                                    </div>
                                    <div class="edit-icon">
                                        <svg>
                                ...
                                <div class="flex-grow align-self-center ms-2 ">
                                    <h1 class="mt-0 user-name">Akun Karimun</h1>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="progress-showcase row mt-3">
                        <div class="col">
                            <div class="progress progress-border-primary">
                                <?php
                                    $debet = $saldo['saldodebetkarimun'];   // Pemasukan
                                    $kredit = $saldo['saldokreditkarimun']; // Pengeluaran
                    ...
                    <div class="social-details">
                        ...
                        <ul class="social-follow"
                            ...
                            <li style="flex: 1;">
                                <h5 class="mb-0" style="margin-bottom: 2px; font-size: clamp(11px, 2vw, 18px);">
                                    Rp. <?= number_format($saldo['saldodebetkarimun'], 0, ',', '.') ?>
                                </h5>
                            ...
                            <li
                                ...
                                <h5 class="mb-0" style="margin-bottom: 2px; font-size: clamp(11px, 2vw, 18px);">
                                    Rp. <?= number_format($saldo['saldokreditkarimun'], 0, ',', '.') ?>
                                </h5>
                            ...
                            <li style="flex: 1;">
                                <h5 class="mb-0" style="margin-bottom: 2px; font-size: clamp(11px, 2vw, 18px);">
                                    Rp. <?= number_format($saldo['saldokarimun'], 0, ',', '.') ?>
                                </h5>
                        ...
                        <!-- <ul class="social-follow">
                            <li>
                                <h5 class="mb-0">Rp. <?= number_format($saldo['saldodebetkarimun'], 0, ',', '.') ?></h5>
                                <span class="f-light">Budget Saldo</span>
                            </li>
                            <li>
                                <h5 class="mb-0">Rp. <?= number_format($saldo['saldokreditkarimun'], 0, ',', '.') ?>
                                </h5><span class="f-light">Pengeluaran (Kredit)</span>
                            </li>
                            <li>
                                <h5 class="mb-0">Rp. <?= number_format($saldo['saldokarimun'], 0, ',', '.') ?></h5><span
                                    class="f-light">Sisa Saldo</span>
                            </li>
                        </ul> -->
                    </div>
                    <?php endforeach; ?>
            ...
            <div class="card">
                <div class="card-header card-no-border">
                    <div class="header-top">
                        ...
                        $total_inprogress_done = $this->db->where('jenis_saldo', 'TBK')
                            ->where('status_cab', 'In progress')
                            ->where('rembesment', 'Open')
                ...
                <div class="card-body pt-0">
                    ...
                    <div class="table-responsive mb-4">
                        <table class="last-orders-table table" id="last-orders">
                            ...
                            <tbody>
                                <?php $no = 1;
                                foreach ($rowtransaksikarimun as $data) { ?>
                    ...
                    <form class="row g-3 needs-validation"
                        ...
                        <div class="card-wrapper">
                                ...
                                <div class="mb-3">
                                    <div class="input-group">
                                        <input class="form-control" type="text" id="no-bpkk-display" name="no_bpkk"
                                            value="<?= $no_bpkkkarimun; ?>" placeholder="BPKK-SBU/0000/MM/YYYY"
                                            readonly>
                            ...
                            <div class="row mb-3">
                                ...
                                <?php
                                $saldo = 0;
                                $saldo = $this->db->get_where('tb_saldo', ['jenis_saldo' => 'TBK'])->row()->saldo_pettycash ?? 0;
                                ?>
                                <div class="col-md-6">
                                    ...
                                    <input type="hidden" id="address_cab" name="address_cab" value="TBK">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <label class="form-label txt-dark" for="formFile">Upload Dokumen Pendukung : (Bukti
                                        Pengeluaran - Kwitansi)</label>
